...
and d_date between '1999-03-04' and 
        (cast('1999-03-04' as date) + 90 days)
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Lakewood','Shiloh','Lakeside','Dixie','Rosedale') 
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (8,12,2,7,6,11) and
       d_year = 2001 and
       ca_state in ('WV','TN','NY'
                   ,'CO','TX','AL','MO')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Cocke County','Mariposa County','Oglethorpe County','Levy County')
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and (household_demographics.hd_dep_count = 0 or
             household_demographics.hd_vehicle_count= -1)
        and date_dim.d_year in (1999,1999+1,1999+2)
        and store.s_city in ('Needmore','Anderson')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('floral','moccasin','medium'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 6
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2000) and
        ((i_category in ('Home','Sports','Books') and
          i_class in ('curtains/drapes','pools','fiction')
         )
      or (i_category in ('Women','Men','Jewelry') and
          i_class in ('dresses','accessories','rings') 
        ))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-07-11','2000-08-05','2000-11-03')))
...
select   
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'BARIAN' || ',' || 'ORIENTAL' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 22651 and 22651+28800 
 	and sm_carrier in ('BARIAN','ORIENTAL')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('1999-05-19' as date) - 30 days)
                    and (cast ('1999-05-19' as date) + 30 days)
...
select  i_item_id
 ...
 and d_date between cast('2000-06-23' as date) and (cast('2000-06-23' as date) +  60 days)
 and i_manufact_id in (473,956,316,959)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Sulphur Springs'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  69957
   and ib_upper_bound   <=  69957 + 50000
...
select  i_item_id
 ...
 and d_date between cast('1999-01-08' as date) 
 				and (cast('1999-01-08' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('burnished','rose','forest','drab','blue','misty') and
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 147 and 147+10
          or ss_coupon_amt between 10715 and 10715+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 21 and 21+10
          or ss_coupon_amt between 8730 and 8730+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 178 and 178+10
          or ss_coupon_amt between 11653 and 11653+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 48 and 48+10
          or ss_coupon_amt between 3490 and 3490+1000
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Somerset County','Pulaski County','Adams County','Miller County',
                           'Halifax County','Raleigh County','Van Buren County','Coal County')
