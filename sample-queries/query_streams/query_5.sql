...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Henry County','Mesa County','Warren County','Orange County')
...
select  
 ...
 and d_date between (cast ('2002-04-12' as date) - 30 days)
...
select  i_item_id
 ...
 and d_date between cast('1999-03-31' as date) and (cast('1999-03-31' as date) +  60 days)
 and i_manufact_id in (251,919,865,133)
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('green','indian','olive'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 2
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Bethlehem','Red Hill','Riverdale','Smithville','Ashland') 
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Watson','Green Acres')
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (6,12,11,4,8,7) and
       d_year = 2001 and
       ca_state in ('MT','OH','MS'
                   ,'NC','TX','ID','AR')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-01-24','1998-09-08','1998-11-10')))
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Spring Valley'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  53097
   and ib_upper_bound   <=  53097 + 50000
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 91 and 91+10 
             or ss_coupon_amt between 3372 and 3372+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 163 and 163+10
          or ss_coupon_amt between 7029 and 7029+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 182 and 182+10
          or ss_coupon_amt between 10537 and 10537+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 76 and 76+10
          or ss_coupon_amt between 1299 and 1299+1000
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Women','Books','Electronics') and
          i_class in ('swimwear','self-help','portable')
         )
      or (i_category in ('Children','Music','Men') and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MS', 'LA', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NC', 'AZ', 'ND')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OR', 'NY', 'NE')
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('blanched','dim','frosted','navajo','snow','dark') and
...
and d_date between '2001-01-23' and 
        (cast('2001-01-23' as date) + 90 days)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 38708 and 38708+28800 
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Quay County','Terrell County','Levy County','Reagan County',
                           'Richland County','Surry County','Camden County','Wadena County')
...
where 
	...
	and d_date between cast('2002-04-06' as date) 
				and (cast('2002-04-06' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
