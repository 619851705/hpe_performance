...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Ashland','Edgewood')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Gage County','Appanoose County','Cocke County','Walker County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Five Points'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  4201
   and ib_upper_bound   <=  4201 + 50000
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2002-04-30' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2002-04-30' as date) - 30 days)
                    and (cast ('2002-04-30' as date) + 30 days)
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Cocke County','Tehama County','Pennington County','Maverick County',
                           'Montgomery County','Salem County','Stillwater County','Green Lake County')
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Hillsdale','Hillcrest','Waterloo','Shady Grove','Waverly') 
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 44223 and 44223+28800 
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('antique','coral','puff'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 2
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('blush','sienna','medium','blanched','purple','papaya') and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('WI', 'AR', 'IL')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'IA', 'PA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AZ', 'WV', 'LA')
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 156 and 156+10
          or ss_coupon_amt between 9608 and 9608+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 124 and 124+10
          or ss_coupon_amt between 9197 and 9197+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 38 and 38+10
          or ss_coupon_amt between 13800 and 13800+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 127 and 127+10
          or ss_coupon_amt between 8423 and 8423+1000
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (5,11,9,3,6,1) and
       d_year = 2001 and
       ca_state in ('NV','TX','MN'
                   ,'IL','NH','VA','OK')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Shoes','Books','Jewelry') and
          i_class in ('athletic','cooking','consignment')
         )
      or (i_category in ('Electronics','Men','Home') and
          i_class in ('musical','sports-apparel','wallpaper') 
        ))
...
select  i_item_id
 ...
 and i_manufact_id in (828,240,930,88)
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-04-14','1999-09-17','1999-11-19')))
