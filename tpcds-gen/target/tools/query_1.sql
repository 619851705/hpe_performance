...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-04-20','2000-09-12','2000-11-18')))
...
and d_date between '2001-01-27' and 
        (cast('2001-01-27' as date) + 90 days)
...
and d_date between '1998-03-28' and 
        (cast('1998-03-28' as date) + 90 days)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 11022 and 11022+28800 
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Glendale'
   ...
   and ib_lower_bound   >=  36091
   and ib_upper_bound   <=  36091 + 50000
...
and cc_county in ('Wadena County','San Miguel County','Jackson County','Pennington County',
                  'Maverick County'
)
and exists (select *
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-04-27' as date) - 30 days)
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('NM', 'OR', 'MT')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KS', 'NV', 'LA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'OK', 'WI')
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 6 and 6+10 
             or ss_coupon_amt between 8791 and 8791+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 75 and 75+10
          or ss_coupon_amt between 4945 and 4945+1000
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 884 and 884+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'orange' or i_color = 'bisque') and 
        (i_units = 'Dram' or i_units = 'Pallet') and
        (i_size = 'N/A' or i_size = 'extra large')
        ) or
        (i_category = 'Women' and
        (i_color = 'burlywood' or i_color = 'aquamarine') and
        ...
        (i_category = 'Men' and
        (i_color = 'hot' or i_color = 'violet') and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '27999','16901','46585','34029','99403','86730',
                          '82264','42457','91415','71901','43783',
                          '38162','87481','18465','30283','35976',
                          '87982','23948','12606','15492','51486',
                          '43706','10560','24931','72975','76536',
                          '25449','53915','55621','55704','52371',
                          '91458','86330','55690','16236','68414',
                          '52220','78323','22020','75688','85291',
                          '60074','11419','19803','15306','42675',
                          '44892','89753','69931','73439','85847',
                          '74950','53846','63292','21597','45474',
                          '26367','26175','40277','79412','79000',
                          '45065','29892','62653','53030','10927',
                          '43371','95038','21821','80988','69371',
                          '58285','21944','76796','62956','53577',
                          '79567','26094','52746','64163','66447',
                          '44936','40560','70344','87684','37372',
                          '98118','45080','73349','67993','76123',
                          '68096','60252','89784','75932','77679',
                          '52366','59204','35960','43248','84406',
                          '72639','61341','52159','52352','44610',
                          '20533','26788','57933','44086','56053',
                          '69791','16981','96727','69965','29907',
                          '93594','37983','83249','97114','30391',
                          '33065','54330','67690','80160','41916',
                          '45679','93921','92291','54478','92167',
                          '95009','86685','27403','46555','53686',
                          '97009','93030','69542','36604','66472',
                          '60212','61244','34840','42907','47988',
                          '70659','38292','40601','31409','10773',
                          '21809','14756','43277','98664','45230',
                          '67619','52413','72959','81657','56205',
                          '98865','96438','16742','98983','92680',
                          '52610','89711','55937','72541','97218',
                          '52900','74263','55150','36163','68456',
                          '41728','44813','92594','70327','68746',
                          '66873','26731','95301','44673','19747',
                          '34007','32003','62074','25502','97310',
                          '54458','43429','54039','83124','77506',
                          '44324','29756','40492','26381','21762',
                          '17179','74115','36307','33791','55322',
                          '55378','12347','96604','11215','81833',
                          '61789','71593','45621','72115','61138',
                          '47937','53629','89470','23838','80225',
                          '70128','54424','19242','97240','33535',
                          '23611','42110','75271','76320','46444',
                          '92284','25973','14940','24914','59411',
                          '79332','99983','30786','20809','90889',
                          '72615','42558','74670','63059','12369',
                          '14280','33466','14563','57737','48471',
                          '13188','39785','52055','47764','39533',
                          '24114','11029','84590','82618','30048',
                          '60140','96583','30922','73271','56118',
                          '74925','71280','71198','80536','38429',
                          '19588','43561','62881','88190','37581',
                          '96316','90063','93700','33573','39223',
                          '67866','39934','85420','31153','32808',
                          '82836','20426','81096','49269','54408',
                          '24724','69074','53128','58850','89096',
                          '81065','93373','57046','39679','83266',
                          '44433','23125','40163','58168','78527',
                          '86270','28500','74833','57676','55155',
                          '47642','52664','97969','21543','67762',
                          '44600','14517','86522','46502','53637',
                          '76654','44429','45738','47669','24200',
                          '29646','32044','85526','65278','51946',
                          '90594','24036','96709','42914','49138',
                          '99538','65365','14383','37857','75203',
                          '82033','59640','76990','79974','66111',
                          '52241','26837','34858','57253','50593',
                          '48919','70017','23527','19637','52229',
                          '18561','51722','42678','13019','17578',
                          '86472','50816','96045','11346','98294',
                          '18254','78623','42074','58287','40630',
                          '62365','73119','23843','66488','57329',
                          '65421','57446','33977','72803','47247',
                          '20984','76388','91522','57744','40113',
                          '74218','62502','80617','50259','26295',
                          '14873','12273','55139','70509','38237',
                          '52226','63947','21532','10331')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and d_date between cast('2001-04-21' as date) and (cast('2001-04-21' as date) +  60 days)
 and i_manufact_id in (824,154,129,456)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (8,6,9,1,3,7) and
       d_year = 1998 and
       ca_state in ('WI','VA','NE'
                   ,'TN','AK','GA','CO')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Monroe','Independence')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 213340599
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 263365861
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 413450984
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 51246840
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 468650656
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-04-20' as date) and (cast('1999-04-20' as date) +  60 days)
 and i_manufact_id in (739,759,839,923)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('bisque','chartreuse','metallic','blanched','coral','steel') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Five Forks','Franklin','Union Hill','Crossroads','Valley View') 
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2000-04-10' as date) - 30 days)
...
select  i_item_id
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('2001-05-03' as date) 
 				and (cast('2001-05-03' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Miller County','Stillwater County','Perry County','Dauphin County',
                           'Lunenburg County','Gage County','Appanoose County','Williamson County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Shoes','Women','Children') and
          i_class in ('mens','fragrances','newborn')
         )
      or (i_category in ('Music','Electronics','Books') and
          i_class in ('classical','camcorders','history') 
        ))
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Glades County','Waller County','Webster County','Weld County','Strafford County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Surry County','Chambers County','Montgomery County','Quay County')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('ivory','violet','cornflower'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 6
