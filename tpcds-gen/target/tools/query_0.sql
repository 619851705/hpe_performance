...
and d_date between '1999-02-11' and 
        (cast('1999-02-11' as date) + 90 days)
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2002-02-17' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2002-02-17' as date) - 30 days)
                    and (cast ('2002-02-17' as date) + 30 days)
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('beige','puff','navy','plum','lime','chiffon') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Glenwood','Brownsville','Spring Hill','Friendship','Mount Pleasant') 
...
and cc_county in ('Richland County','Daviess County','Walker County','Franklin Parish',
                  'Huron County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Overton County','Decatur County','Sierra County','Washington Parish','Norton County') and
...
select  i_item_id
 ...
 and i_manufact_id in (753,947,748,836)
...
where 
	...
	and d_date between cast('1999-06-15' as date) 
				and (cast('1999-06-15' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 161 and 161+10 
             or ss_coupon_amt between 3624 and 3624+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 7 and 7+10
          or ss_coupon_amt between 13368 and 13368+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 64 and 64+10
          or ss_coupon_amt between 1362 and 1362+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 67 and 67+10
          or ss_coupon_amt between 4577 and 4577+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 185 and 185+10
          or ss_coupon_amt between 9477 and 9477+1000
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 13012 and 13012+28800 
...
and d_date between '1999-03-19' and 
        (cast('1999-03-19' as date) + 90 days)
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 102343562
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 165030257
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 166267536
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 95065232
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 32448856
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1999) and
        ((i_category in ('Books','Home','Sports') and
          i_class in ('home repair','tables','basketball')
         )
      or (i_category in ('Jewelry','Shoes','Music') and
          i_class in ('jewelry boxes','kids','pop') 
        ))
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '64119','56589','51389','94165','19466','50917',
                          '47780','71235','93699','35017','93922',
                          '21759','45066','86733','76777','78320',
                          '34961','33402','17992','59316','32823',
                          '22866','89653','73273','45212','20753',
                          '41588','97923','23951','17335','23110',
                          '53546','15457','80294','83023','97643',
                          '51474','83183','28256','21623','66276',
                          '10751','61242','54036','90207','27802',
                          '96741','34358','76766','88688','13776',
                          '78804','83892','39313','62441','64039',
                          '63863','36908','27354','12217','41448',
                          '94821','54826','61140','49656','94283',
                          '86344','28614','12340','41208','59567',
                          '54402','23895','29261','71284','61905',
                          '48237','74159','98032','13917','89918',
                          '70252','75676','81239','90251','22024',
                          '52556','40550','26192','96879','68965',
                          '64293','39697','53004','25662','45184',
                          '86892','18426','74475','86297','76166',
                          '66960','36049','80624','42438','35861',
                          '53864','98515','87213','93221','19523',
                          '71903','63929','56922','50902','75482',
                          '14986','17558','73867','66625','70275',
                          '62268','79198','27001','96829','16571',
                          '16161','31306','71306','91739','23124',
                          '59533','69658','30289','29530','64602',
                          '98598','32737','73658','14249','80001',
                          '78974','20810','42583','25631','95252',
                          '51386','14190','63538','99927','47330',
                          '79189','66623','98735','36427','64838',
                          '13023','57210','95703','64622','53536',
                          '36014','27339','83641','57538','87352',
                          '15286','78714','48152','41376','26010',
                          '55614','90235','98278','71795','91941',
                          '23390','20836','16418','11764','36152',
                          '48355','62927','50229','86555','25266',
                          '10345','99551','98615','55290','58603',
                          '11400','54017','20149','57905','19808',
                          '97864','21143','46522','17799','65193',
                          '11213','66152','27803','42558','58831',
                          '80489','75184','77806','55838','73463',
                          '41207','82819','12630','69101','40920',
                          '91638','84306','18109','46915','75164',
                          '73009','93188','52500','40347','82399',
                          '30433','83363','97303','66582','19399',
                          '58167','56286','52584','35641','21174',
                          '27712','84462','78912','31282','49608',
                          '18616','57986','25970','16446','40879',
                          '38630','82560','80810','57655','42787',
                          '68844','35876','93795','25791','33481',
                          '28674','14194','64707','97092','98551',
                          '90688','32540','52027','94965','73908',
                          '15298','64440','29131','54920','39669',
                          '75198','14827','26353','18204','48425',
                          '96063','41987','79598','33261','34645',
                          '16715','48235','11686','23132','62724',
                          '27307','79599','38068','96240','35740',
                          '60138','78702','31046','64295','72384',
                          '86027','62665','31794','61218','32839',
                          '71267','92405','51461','62187','83663',
                          '20840','30944','31055','87818','68919',
                          '70842','61407','24741','22917','11897',
                          '40209','71536','10434','13853','10915',
                          '28338','22888','89401','54554','15115',
                          '20294','84898','28678','61993','54356',
                          '54307','95142','49941','86833','53976',
                          '83484','81837','17520','86432','80476',
                          '16104','58905','51443','27878','56950',
                          '44995','77985','37233','33962','12923',
                          '72395','52560','63126','22521','79685',
                          '25775','28462','66255','12185','83588',
                          '44179','14128','31010','14869','90978',
                          '87095','11580','64783','98079','20540',
                          '46477','30228','14275','91693','83722',
                          '92012','41708','45901','14008','56960',
                          '48366','46363','24887','64739','49027',
                          '33671','18366','33259','12188','86852',
                          '38548','34791','49741','60131','24767',
                          '86372','21936','35790','49750')
     intersect
      select ca_zip
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('2001-04-26' as date) 
...
select  i_item_id
 ...
 and d_date between cast('2000-03-07' as date) 
 				and (cast('2000-03-07' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-02-07' as date) and (cast('2001-02-07' as date) +  60 days)
 and i_manufact_id in (979,793,806,882)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Marshall County','Mobile County','Raleigh County','Perry County',
                           'Terry County','Hubbard County','Harding County','Pulaski County')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Surry County','Daviess County','Karnes County','Orange County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Providence'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  765
   and ib_upper_bound   <=  765 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('goldenrod','blue','deep'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 4
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2000-06-05' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-06-05' as date) - 30 days)
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (8,4,7,1,11,5) and
       d_year = 2002 and
       ca_state in ('KS','KY','TX'
                   ,'MO','GA','AL','SC')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MO', 'AR', 'VA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('GA', 'ND', 'MD')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TN', 'KS', 'OK')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Valley View','Mount Carmel')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-04-11','2001-10-04','2001-11-05')))
