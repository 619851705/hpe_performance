...
and d_date between '1999-03-29' and 
        (cast('1999-03-29' as date) + 90 days)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 38095 and 38095+28800 
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Macedonia'
   ...
   and ib_lower_bound   >=  52405
   and ib_upper_bound   <=  52405 + 50000
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '39042','92726','43929','46006','22473','36815',
                          '60440','80119','26089','80781','51026',
                          '31786','59195','72748','54795','33622',
                          '19524','30750','24766','93597','90499',
                          '87165','44521','20973','58932','18281',
                          '44528','25119','63279','83294','29404',
                          '38023','39846','91368','74611','23739',
                          '62503','11486','10071','15762','49306',
                          '52986','22167','67845','32534','93204',
                          '44115','85996','80665','44662','72640',
                          '17717','14934','67202','51858','39631',
                          '17979','77974','68781','78174','61564',
                          '74430','75695','87024','80590','49169',
                          '62310','90480','90539','92220','90325',
                          '76098','14526','90237','37227','81127',
                          '17349','51048','76075','52580','93683',
                          '74936','87276','33191','41247','31546',
                          '83018','90343','45068','48831','34281',
                          '92862','59996','46409','85498','67836',
                          '66988','68484','25150','39440','18258',
                          '12526','78512','87058','10108','90345',
                          '60139','26510','90206','95793','17933',
                          '44786','21994','30313','12724','81834',
                          '41008','17151','30344','35157','78993',
                          '67509','60358','57049','38143','26368',
                          '49969','57022','89345','96376','50621',
                          '34392','42532','75039','17479','19353',
                          '83675','49930','32110','40664','54168',
                          '39255','54423','95737','47810','26267',
                          '28239','47252','78842','35042','89025',
                          '55497','53599','39305','74208','13546',
                          '45287','74812','46474','20035','77906',
                          '52099','29656','93551','55684','68459',
                          '13789','73930','91367','13460','81690',
                          '15703','58268','45851','12577','49684',
                          '96345','52133','43050','89610','93621',
                          '92040','21634','92951','97855','46283',
                          '88711','21893','68558','89164','41995',
                          '85706','34522','88834','23913','49202',
                          '89052','26229','76097','92881','53656',
                          '21075','13095','90165','72017','75595',
                          '17388','86534','74681','20492','75460',
                          '29460','69990','60688','53600','31171',
                          '46151','72954','68605','94796','75557',
                          '52151','38369','75544','84799','41702',
                          '27984','41906','34435','64197','63799',
                          '30250','25234','85821','87241','93305',
                          '70657','34069','14377','33702','90020',
                          '19047','36198','10340','92632','23357',
                          '16012','29890','39723','15034','35567',
                          '85062','60061','34509','51120','71616',
                          '37441','70488','28600','58360','52969',
                          '35308','91098','56442','87460','77460',
                          '74910','88507','99963','48475','92636',
                          '93583','46404','83797','90360','70327',
                          '31161','96551','52437','91928','41641',
                          '16781','19038','77101','54601','33769',
                          '16253','53663','67649','67311','83077',
                          '26993','65172','29723','96519','62846',
                          '21807','33782','52978','50585','38140',
                          '85965','50231','63209','41886','28412',
                          '86662','81593','59040','53851','74778',
                          '89521','13314','71081','24241','18513',
                          '87231','75712','42264','80959','49984',
                          '60339','16753','94139','21231','26042',
                          '16498','63977','39602','15518','84536',
                          '83299','22508','15128','98736','88331',
                          '63023','49272','64889','74917','59336',
                          '31032','91808','65035','44812','66376',
                          '80120','49062','63370','90166','11499',
                          '72402','79658','42133','22993','79677',
                          '64788','56518','89635','23537','42363',
                          '72977','61917','78731','55463','99951',
                          '63360','42335','93527','33039','62971',
                          '18772','40243','26921','65055','49942',
                          '40410','47022','72126','98429','10019',
                          '73847','10375','41120','31596','99644',
                          '56782','32460','13914','20715','28476',
                          '42666','87690','57408','46603','74455',
                          '50229','34412','74691','76259')
     intersect
      select ca_zip
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Jewelry','Men','Women') and
          i_class in ('gold','accessories','fragrances')
         )
      or (i_category in ('Home','Children','Music') and
          i_class in ('bedding','infants','pop') 
        ))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Cloverdale','Mountain View','Five Forks','Georgetown','Rose Hill') 
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-02-10','1999-08-11','1999-11-05')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 104 and 104+10 
             or ss_coupon_amt between 3245 and 3245+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 182 and 182+10
          or ss_coupon_amt between 17915 and 17915+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 148 and 148+10
          or ss_coupon_amt between 15465 and 15465+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 35 and 35+10
          or ss_coupon_amt between 10967 and 10967+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 69 and 69+10
          or ss_coupon_amt between 2004 and 2004+1000
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,9,1,3,6,11) and
       d_year = 1999 and
       ca_state in ('OR','KY','WV'
                   ,'FL','IN','TX','PA')
...
select  i_item_id
 ...
 and i_manufact_id in (1000,743,977,809)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Phelps County','Cleveland County','Elbert County','Columbia County','Rockingham County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-03-05' as date) and (cast('2000-03-05' as date) +  60 days)
 and i_manufact_id in (829,645,530,503)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('peru','misty','light'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 2
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Waterloo','Highland')
...
and cc_county in ('Walker County','Huron County','Levy County','Pennington County',
                  'Williamson County'
)
and exists (select *
...
select  i_item_id
 ...
 and d_date between cast('2001-05-27' as date) 
 				and (cast('2001-05-27' as date) + 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
where 
	...
	and d_date between cast('1999-01-15' as date) 
				and (cast('1999-01-15' as date) + 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Van Buren County','Terrell County','Arthur County','Stillwater County',
                           'Fairfield County','Harmon County','Ziebach County','Camden County')
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('misty','tan','seashell','bisque','light','thistle') and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('FL', 'KY', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('VT', 'ID', 'MS')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('PA', 'VA', 'MO')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Karnes County','Wadena County','Terry County','Walker County')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 297712703
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 189412208
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 200245207
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 443789984
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 34990636
            then (select avg(ss_ext_sales_price)
                  from store_sales
