...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('grey','indian','linen'))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-06-30','2001-09-09','2001-11-08')))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 186 and 186+10
          or ss_coupon_amt between 13548 and 13548+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 32 and 32+10
          or ss_coupon_amt between 13807 and 13807+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 97 and 97+10
          or ss_coupon_amt between 11241 and 11241+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 173 and 173+10
          or ss_coupon_amt between 9252 and 9252+1000
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Woodlawn','Milltown')
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '65710','32642','50731','82248','13763','25323',
                          '47555','95772','21206','51321','30717',
                          '13947','16735','49234','88063','68665',
                          '83798','47502','15044','81515','39113',
                          '86786','23810','31072','26354','70798',
                          '27684','57797','38144','63969','96657',
                          '71500','97389','46505','78869','43030',
                          '34266','42470','34840','64589','58053',
                          '15754','77883','48590','20882','39256',
                          '31409','30048','12082','32350','95650',
                          '72913','91347','10610','92257','10644',
                          '66038','34214','48945','66137','99910',
                          '46879','26342','65866','75522','90149',
                          '41587','85460','78096','10937','99035',
                          '72946','59393','80844','42362','87666',
                          '87459','10317','21966','59724','69102',
                          '43761','91740','84172','47214','33271',
                          '62771','76769','61553','85047','59500',
                          '67753','52849','44868','38337','83571',
                          '79324','29696','68099','39186','18008',
                          '63642','91095','68668','14855','23433',
                          '18676','33237','61243','53570','72236',
                          '56881','87602','42857','37050','91989',
                          '66569','20939','42948','91025','41678',
                          '62297','41882','78234','74009','34543',
                          '71656','21724','27314','21525','87214',
                          '59762','46358','65079','30630','32107',
                          '20057','34864','17027','99830','95260',
                          '20971','14655','91553','49799','29456',
                          '12403','39118','83228','99622','62051',
                          '85470','62489','49936','16145','11674',
                          '60682','68904','76369','13847','37908',
                          '21779','59304','84234','96956','48777',
                          '36358','93782','61549','10971','14933',
                          '31859','94599','97735','49689','50724',
                          '55998','48405','63967','50541','84146',
                          '81497','29375','92295','89805','58639',
                          '33830','74427','50487','68172','58153',
                          '62045','73148','97633','79638','34481',
                          '11006','89700','64344','90466','69570',
                          '56263','93245','29560','26503','47640',
                          '48847','74698','19906','38981','45364',
                          '83754','77411','11958','86466','38225',
                          '95092','76969','45915','44926','15983',
                          '37962','80888','81148','23156','78388',
                          '71790','98135','93789','53095','90855',
                          '19064','81699','79692','54572','78021',
                          '32672','79947','56267','81668','40463',
                          '88850','59732','21023','86988','49667',
                          '80114','30008','37427','79027','79019',
                          '27611','39205','47019','71912','68592',
                          '98313','78987','16424','71075','63423',
                          '78274','72254','54631','37719','97533',
                          '26517','44408','43474','50276','30302',
                          '60600','71809','15179','31709','50575',
                          '86358','23592','52039','92475','80110',
                          '91782','40226','86183','16281','34715',
                          '97573','48915','55553','97101','19877',
                          '13109','31889','85796','38385','65411',
                          '95942','10941','45277','61289','92522',
                          '69494','74932','54601','82397','73150',
                          '56169','40999','61192','43445','93093',
                          '55416','24091','24078','61246','36876',
                          '16405','67819','41536','27377','95857',
                          '80985','82281','13668','38599','67714',
                          '69256','90034','95608','56842','34014',
                          '28412','42999','84450','56228','74759',
                          '53944','90603','62995','86683','43169',
                          '82994','20250','86491','33633','28185',
                          '67635','29836','57943','27363','34716',
                          '69193','63991','72399','55589','12430',
                          '31341','23222','79774','21987','57110',
                          '90616','48577','60662','94793','49776',
                          '14873','46934','79810','53808','36158',
                          '75785','21008','55606','14403','96283',
                          '60220','46322','21991','72403','64679',
                          '72920','74969','56147','46469','38506',
                          '12922','35260','86669','69252','13539',
                          '36368','99286','40390','81774','94049',
                          '52537','81903','11789','40937')
     intersect
      select ca_zip
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2002-05-30' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2002-05-30' as date) - 30 days)
                    and (cast ('2002-05-30' as date) + 30 days)
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Delaware County','Siskiyou County','Webster County','Lincoln County','Gilmer County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast('1998-01-27' as date) and (cast('1998-01-27' as date) +  60 days)
 and i_manufact_id in (686,449,183,971)
...
and cc_county in ('Bronx County','Gage County','Mobile County','Daviess County',
                  'Jackson County'
)
and exists (select *
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Harding County','Sumner County','Somerset County','Abbeville County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Wildwood'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  11965
   and ib_upper_bound   <=  11965 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-05-05' as date) and (cast('2000-05-05' as date) +  60 days)
 and i_manufact_id in (680,784,948,668)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('snow','chocolate','red','dim','honeydew','ghost') and
...
select  i_item_id
 ...
 from	catalog_sales
     ...
     ,date_dim
 where cs_item_sk = i_item_sk 
   and i_category in ('Men', 'Women', 'Shoes')
   and cs_sold_date_sk = d_date_sk
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 263051613
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 371391376
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 395805211
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 38267205
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 304793685
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,5,8,10,6,3) and
       d_year = 1999 and
       ca_state in ('OH','MS','AR'
                   ,'TX','NY','TN','KY')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Fairfield County','Wadena County','Levy County','Sierra County',
                           'Pipestone County','Grant County','Brazos County','Pulaski County')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('ME', 'IA', 'KY')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'MT', 'CO')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OR', 'GA', 'OK')
 ...
 where i_manufact_id between 745 and 745+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'peach' or i_color = 'frosted') and 
        ...
        (i_category = 'Men' and
        (i_color = 'goldenrod' or i_color = 'lime') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Sharon','Buena Vista','Plainview','Georgetown','Farmington') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Books','Men','Home') and
          i_class in ('parenting','accessories','lighting')
         )
      or (i_category in ('Electronics','Shoes','Children') and
          i_class in ('camcorders','athletic','infants') 
        ))
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 1744 and 1744+28800 
