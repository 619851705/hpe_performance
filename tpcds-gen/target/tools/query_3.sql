...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Shoes','Music','Sports') and
          i_class in ('kids','country','hockey')
         )
      or (i_category in ('Children','Home','Men') and
          i_class in ('newborn','bedding','sports-apparel') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,5,9,4,3,8) and
       d_year = 2000 and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('powder','ghost','chartreuse'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 7
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TN', 'NC', 'NM')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ND', 'IL', 'LA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('CA', 'FL', 'KY')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Mount Olive'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  57909
   and ib_upper_bound   <=  57909 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Anderson County','Sibley County','Faribault County','Harrison County','Bay County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '98492','96904','87087','21325','85095','30440',
                          '27157','31419','72244','10989','35128',
                          '30423','93908','56107','83127','32583',
                          '20899','27284','71952','10811','59045',
                          '36846','40181','70348','25125','74418',
                          '20830','72338','34246','19434','57808',
                          '94891','32067','16838','61290','57613',
                          '64917','33855','43157','47397','99873',
                          '21323','34203','24236','21840','70658',
                          '59127','27881','81838','42491','62625',
                          '21967','11935','24175','62776','37774',
                          '31757','31491','99036','20979','18230',
                          '35092','53528','52940','57906','96213',
                          '72916','66999','28382','82895','23876',
                          '11373','47051','50277','21084','93128',
                          '35230','81161','86667','20860','61933',
                          '53476','63486','74593','91172','71588',
                          '31748','68239','57840','17715','96540',
                          '40746','64768','38523','15203','62010',
                          '78085','58972','96532','49085','71595',
                          '66346','50489','36152','99787','63368',
                          '14208','82628','46518','28791','66521',
                          '94773','62648','19039','13030','60359',
                          '35876','27652','94183','82900','83431',
                          '70828','39602','48117','40199','62256',
                          '15054','92929','48997','37045','17617',
                          '53515','67977','52600','65107','19472',
                          '76866','70853','72944','78104','73660',
                          '46892','83723','73020','81234','39898',
                          '73650','86439','51866','21295','26190',
                          '95414','35561','14362','91965','65721',
                          '24468','46598','23320','50334','45285',
                          '67356','62214','71645','88094','32434',
                          '34373','36026','20575','92900','80337',
                          '65028','98641','21695','29239','40727',
                          '35970','98049','72329','11957','58483',
                          '73596','74042','15632','34499','85667',
                          '82602','71453','84701','87800','24241',
                          '78732','54419','95309','19871','26328',
                          '16870','33097','24160','55327','74163',
                          '90135','61279','65166','86982','31439',
                          '37946','41540','51348','59939','38208',
                          '78816','98233','69056','80071','24764',
                          '10688','47992','62947','40888','69732',
                          '60024','34653','31810','97714','80151',
                          '22768','40327','67502','10317','87027',
                          '66711','24819','97148','36107','33567',
                          '56677','41589','33561','77359','42060',
                          '74650','93374','78804','57542','63682',
                          '33228','19836','32887','44561','30396',
                          '80787','83365','34573','37819','74452',
                          '98871','38001','96490','83989','12991',
                          '49386','77242','23880','57569','22540',
                          '86796','64736','41230','48467','51971',
                          '39594','77390','51694','67343','95841',
                          '53126','65700','18024','50426','48156',
                          '22541','92297','96814','21991','15684',
                          '74199','11318','86641','12350','89990',
                          '87923','55937','43750','74594','67288',
                          '34859','41780','36008','71023','81597',
                          '17806','24388','92087','12868','48885',
                          '48028','51594','63287','21412','34534',
                          '44575','20000','37434','17858','19025',
                          '17210','79271','27511','23416','41170',
                          '28033','10285','15604','77088','84940',
                          '74799','75001','13383','42957','51425',
                          '97947','85100','80614','72297','81056',
                          '27971','79283','55362','26011','31367',
                          '21575','68948','67603','61691','89150',
                          '33757','99394','45894','27520','77246',
                          '68177','22657','54740','19541','19825',
                          '72661','85632','47365','66951','22611',
                          '41385','37934','14297','96370','44505',
                          '64978','18630','29342','28267','75664',
                          '91899','78234','91441','43735','52915',
                          '59700','39064','10916','71274','56527',
                          '82272','72976','11387','31273','60181',
                          '27522','41732','35603','17793','89707',
                          '29356','28724','76909','82550','13299',
                          '13250','62516','98325','64478')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and i_manufact_id in (718,976,716,838)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 42698 and 42698+28800 
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1998-02-07' as date) - 30 days)
...
select  i_item_id
 ...
 and i_manufact_id in (970,535,750,907)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Pine Grove','Lakewood','Westwood','Forest Park','Franklin') 
 ...
 where i_manufact_id between 794 and 794+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'green' or i_color = 'black') and
...
and cc_county in ('Williamson County','Mobile County','San Miguel County','Daviess County',
                  'Jackson County'
)
and exists (select *
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Jackson County','Montgomery County','Fairfield County','West Feliciana Parish',
                           'Anderson County','Karnes County','Somerset County','Hubbard County')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Sunnyside','Glendale')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-03-21','2000-09-11','2000-11-08')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 98 and 98+10 
             or ss_coupon_amt between 276 and 276+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 128 and 128+10
          or ss_coupon_amt between 13121 and 13121+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 104 and 104+10
          or ss_coupon_amt between 11819 and 11819+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 28 and 28+10
          or ss_coupon_amt between 8194 and 8194+1000
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('purple','seashell','indian','goldenrod','papaya','red') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 410643178
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 401822815
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 310094162
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 368283286
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 75045326
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Sierra County','Sumner County','Terrell County','Raleigh County')
